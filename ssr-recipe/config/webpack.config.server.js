...
module.exports = {
    ...
    target: 'node',          //node 환경에서 실행될 것을 알려줌
    output: {
                ...
                oneOf: [
                    ...
                    //url-lodaer설정
                    {
                        ...
                        options: {
                            ...
                            limit: 10000,    //원래는 9.78kb가 넘어가면 파일로 저장함
                            //emitFile 값이 false일 경우 경로만 준비하고 파일은 저장하지 않는다
                            name: 'static/media/[name].[hash:8].[ext]'
                        }
                    },
                    //위 에서 설정된 확장자를 제외한 파일들은
                    //file-loader를 사용한다
                    {
                        loader: require.resolve('file-loader'),
                        exclude: [/\.(js|mjs|jsx|ts|tsx)$/, /\.html$/, /\.json$/],
                        options: {
                            emitFile: false, //파일을 따로 저장 하지 않아도 되는 옵션
                            name: 'static/media/[name].[hash: 8].[ext]'
                        }
                    }
                ]
